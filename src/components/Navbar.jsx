...
export default function Navbar({changeCity, settings, setSettings}) {
  ...
  return (
    <div className='flex w-full max-h-[70px] glass rounded-none bg-black text-white'>
        <ul className='flex w-full text-[24px] font-semibold font-Roboto items-center justify-center'>
            ...
            <li className="mr-[5vw] h-full flex items-center justify-center">Home</li>
            <li className="mr-[5vw] h-full flex items-center justify-center">Cities</li>
